...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable$GameStateListener;)V
    ...
    iget-object v2, p0, Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable;->mContext:Landroid/content/Context;

    invoke-direct {v1, v2}, Lcom/google/android/settings/gestures/assist/AssistGestureHelper;-><init>(Landroid/content/Context;)V
    ...
    .line 110
    iget-object p2, p0, Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable;->mPaint:Landroid/graphics/Paint;
    ...
    const-string v1, "assist_gesture_egg_top_score"

    const/4 v2, 0x0

    invoke-static {p2, v1, v2, v0}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-static {p1, p2, v1, v2, v0}, Landroid/provider/Settings$Secure;->getLongForUser(Landroid/content/ContentResolver;Ljava/lang/String;JI)J
...
.method private onGestureDetected()V
    ...
    .line 200
    iget v1, p0, Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable;->mKilledBubbles:I

    iget v4, p0, Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable;->mTopKilledBubbles:I

    if-le v1, v4, :cond_2

    .line 201
    iput v1, p0, Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable;->mTopKilledBubbles:I
    ...
    iget v2, p0, Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable;->mTopKilledBubbles:I

    const/4 v3, -0x2

    const-string v4, "assist_gesture_egg_top_score"
    ...
    iget-wide v4, p0, Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable;->mTopKilledBubblesDate:J

    const-string v2, "assist_gesture_egg_top_score_time"

    invoke-static {v1, v2, v4, v5, v3}, Landroid/provider/Settings$Secure;->putLongForUser(Landroid/content/ContentResolver;Ljava/lang/String;JI)Z
...
.method private onGestureProgress(FI)V
    ...
    iget-boolean v0, p0, Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable;->mBubbleShouldShrink:Z
    ...
    iget-object v1, p0, Lcom/google/android/settings/gestures/assist/bubble/AssistGestureGameDrawable;->mLastShrunkBubble:Lcom/google/android/settings/gestures/assist/bubble/Bubble;

    .line 174
    invoke-virtual {v1}, Lcom/google/android/settings/gestures/assist/bubble/Bubble;->getOriginalSize()I
